...
import (
	...
	clqueryproto "github.com/merlins-labs/merlins/v17/x/concentrated-liquidity/client/queryproto"
...
const (
	...
	addressPrefix                   = "fury"
	localmerlinsFromHomePath        = "/.merlins-local"
	consensusFee                    = "3000ufury"
	denom0                          = "ufury"
	denom1                          = "uusdc"
	tickSpacing              int64  = 100
	accountNamePrefix               = "lo-test"
	// Note, this is localmerlins-specific.
...
func main() {
	...
	log.Printf("\n\n\nWARNING 1: your localmerlins and client home are assummed to be %s. Run 'merlins get-env' and confirm it matches the path you see printed here\n\n\n", clientHome)
...
func createRandomPosition(igniteClient cosmosclient.Client, poolId uint64) (string, int64, int64, sdk.Coins, error) {
	...
	// 1 to 9. These are localmerlins keyring test accounts with names such as:
	// lo-test1
	// lo-test2
	// ...
...
func getClientHomePath() string {
	...
	return currentUser.HomeDir + localmerlinsFromHomePath
}
