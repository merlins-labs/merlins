...
import (
	...
	downtimemodule "github.com/merlins-labs/merlins/v17/x/downtime-detector/module"
	...
	concentratedliquidity "github.com/merlins-labs/merlins/v17/x/concentrated-liquidity/clmodule"
	concentratedliquiditytypes "github.com/merlins-labs/merlins/v17/x/concentrated-liquidity/types"
	cwpoolmodule "github.com/merlins-labs/merlins/v17/x/cosmwasmpool/module"
	...
	"github.com/merlins-labs/merlins/v17/x/ibc-rate-limit/ibcratelimitmodule"
	ibcratelimittypes "github.com/merlins-labs/merlins/v17/x/ibc-rate-limit/types"
	"github.com/merlins-labs/merlins/v17/x/incentives"
	...
	"github.com/merlins-labs/merlins/v17/x/mint"
	minttypes "github.com/merlins-labs/merlins/v17/x/mint/types"
	poolincentives "github.com/merlins-labs/merlins/v17/x/pool-incentives"
	poolincentivestypes "github.com/merlins-labs/merlins/v17/x/pool-incentives/types"
	poolmanager "github.com/merlins-labs/merlins/v17/x/poolmanager/module"
	...
	superfluid "github.com/merlins-labs/merlins/v17/x/superfluid"
	superfluidtypes "github.com/merlins-labs/merlins/v17/x/superfluid/types"
	"github.com/merlins-labs/merlins/v17/x/tokenfactory"
	tokenfactorytypes "github.com/merlins-labs/merlins/v17/x/tokenfactory/types"
	"github.com/merlins-labs/merlins/v17/x/twap/twapmodule"
	twaptypes "github.com/merlins-labs/merlins/v17/x/twap/types"
	"github.com/merlins-labs/merlins/v17/x/txfees"
	...
	valsetprefmodule "github.com/merlins-labs/merlins/v17/x/valset-pref/valpref-module"
...
func OrderEndBlockers(allModuleNames []string) []string {
	...
	// only Merlins modules with endblock code are: twap, crisis, govtypes, staking
...
func (app *MerlinsApp) GetAccountKeeper() simtypes.AccountKeeper {
	return app.AppKeepers.AccountKeeper
}

func (app *MerlinsApp) GetBankKeeper() simtypes.BankKeeper {
	return app.AppKeepers.BankKeeper
}

// Required for ibctesting
func (app *MerlinsApp) GetStakingKeeper() stakingkeeper.Keeper {
	return *app.AppKeepers.StakingKeeper // Dereferencing the pointer
}

func (app *MerlinsApp) GetIBCKeeper() *ibckeeper.Keeper {
	return app.AppKeepers.IBCKeeper // This is a *ibckeeper.Keeper
}

func (app *MerlinsApp) GetScopedIBCKeeper() capabilitykeeper.ScopedKeeper {
	return app.AppKeepers.ScopedIBCKeeper
}

func (app *MerlinsApp) GetPoolManagerKeeper() simtypes.PoolManagerKeeper {
	return app.AppKeepers.PoolManagerKeeper
}

func (app *MerlinsApp) GetTxConfig() client.TxConfig {
