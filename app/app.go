...
import (
	...
	v11 "github.com/merlins-labs/merlins/v17/app/upgrades/v11"
	v12 "github.com/merlins-labs/merlins/v17/app/upgrades/v12"
	v13 "github.com/merlins-labs/merlins/v17/app/upgrades/v13"
	v14 "github.com/merlins-labs/merlins/v17/app/upgrades/v14"
	v15 "github.com/merlins-labs/merlins/v17/app/upgrades/v15"
	v16 "github.com/merlins-labs/merlins/v17/app/upgrades/v16"
	v17 "github.com/merlins-labs/merlins/v17/app/upgrades/v17"
	v3 "github.com/merlins-labs/merlins/v17/app/upgrades/v3"
	v4 "github.com/merlins-labs/merlins/v17/app/upgrades/v4"
	v5 "github.com/merlins-labs/merlins/v17/app/upgrades/v5"
	v6 "github.com/merlins-labs/merlins/v17/app/upgrades/v6"
	v7 "github.com/merlins-labs/merlins/v17/app/upgrades/v7"
	v8 "github.com/merlins-labs/merlins/v17/app/upgrades/v8"
	v9 "github.com/merlins-labs/merlins/v17/app/upgrades/v9"
	_ "github.com/merlins-labs/merlins/v17/client/docs/statik"
)

const appName = "MerlinsApp"
...
var (
	...
	// _ sdksimapp.App = (*MerlinsApp)(nil)
...
// MerlinsApp extends an ABCI application, but with most of its parameters exported.
...
// init sets DefaultNodeHome to default merlins install location.
func init() {
	...
	DefaultNodeHome = filepath.Join(userHomeDir, ".merlins")
}

// initReusablePackageInjections injects data available within merlins into the reusable packages.
...
// NewMerlinsApp returns a reference to an initialized Merlins.
func NewMerlinsApp(
	logger log.Logger,
	db dbm.DB,
...
func (app *MerlinsApp) GetBaseApp() *baseapp.BaseApp {
	return app.BaseApp
}

// Name returns the name of the App.
func (app *MerlinsApp) Name() string { return app.BaseApp.Name() }

// BeginBlocker application updates every begin block.
func (app *MerlinsApp) BeginBlocker(ctx sdk.Context, req abci.RequestBeginBlock) abci.ResponseBeginBlock {
	BeginBlockForks(ctx, app)
	return app.mm.BeginBlock(ctx, req)
}

// EndBlocker application updates every end block.
func (app *MerlinsApp) EndBlocker(ctx sdk.Context, req abci.RequestEndBlock) abci.ResponseEndBlock {
	return app.mm.EndBlock(ctx, req)
}

// InitChainer application update at chain initialization.
func (app *MerlinsApp) InitChainer(ctx sdk.Context, req abci.RequestInitChain) abci.ResponseInitChain {
...
func (app *MerlinsApp) LoadHeight(height int64) error {
...
func (app *MerlinsApp) LegacyAmino() *codec.LegacyAmino {
	return app.cdc
}

// AppCodec returns Merlins' app codec.
//
// NOTE: This is solely to be used for testing purposes as it may be desirable
// for modules to register their own custom testing types.
func (app *MerlinsApp) AppCodec() codec.Codec {
	return app.appCodec
}

// InterfaceRegistry returns Merlins' InterfaceRegistry.
func (app *MerlinsApp) InterfaceRegistry() types.InterfaceRegistry {
	return app.interfaceRegistry
}

func (app *MerlinsApp) ModuleManager() module.Manager {
	return *app.mm
}

// RegisterAPIRoutes registers all application module routes with the provided
// API server.
func (app *MerlinsApp) RegisterAPIRoutes(apiSvr *api.Server, apiConfig config.APIConfig) {
...
func (app *MerlinsApp) RegisterTxService(clientCtx client.Context) {
	authtx.RegisterTxService(app.BaseApp.GRPCQueryRouter(), clientCtx, app.BaseApp.Simulate, app.interfaceRegistry)
}

// RegisterTendermintService implements the Application.RegisterTendermintService
// method.
func (app *MerlinsApp) RegisterTendermintService(clientCtx client.Context) {
	tmservice.RegisterTendermintService(app.BaseApp.GRPCQueryRouter(), clientCtx, app.interfaceRegistry)
}

// configure store loader that checks if version == upgradeHeight and applies store upgrades
func (app *MerlinsApp) setupUpgradeStoreLoaders() {
...
func (app *MerlinsApp) customPreUpgradeHandler(upgradeInfo store.UpgradeInfo) {
...
func (app *MerlinsApp) setupUpgradeHandlers() {
	for _, upgrade := range Upgrades {
