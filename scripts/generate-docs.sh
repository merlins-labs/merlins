...
if [ -d "./client/docs" ]; then
  ...
  #Add public servers to spec file for Merlins testnet and mainnet
  yq -i '."servers"+=[{"url":"https://lcd.merlins.zone","description":"Merlins mainnet node"},{"url":"https://lcd-test.merlins.zone","description":"Merlins testnet node"}]' static/openapi/openapi.yaml
