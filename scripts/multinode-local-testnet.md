...
Validator1: `$HOME/.merlins/validator1`

Validator2: `$HOME/.merlins/validator2`

Validator3: `$HOME/.merlins/validator3`
...
Validator2: `merlins status --node "tcp://localhost:26654"`

Validator3: `merlins status --node "tcp://localhost:26651"`

or

Validator1:
`merlins keys list --keyring-backend test --home $HOME/.merlins/validator1`

Validator2:
`merlins keys list --keyring-backend test --home $HOME/.merlins/validator2`
