...
import (
	...
	"github.com/merlins-labs/merlins/v17/simulation/executor/internal/executortypes"
	"github.com/merlins-labs/merlins/v17/simulation/executor/internal/stats"
...
func simulationHomeDir() string {
	...
	return filepath.Join(userHomeDir, ".merlins_simulation")
}
