...
// source: merlins/incentives/tx.proto
...
func init() {
	proto.RegisterType((*MsgCreateGauge)(nil), "merlins.incentives.MsgCreateGauge")
	proto.RegisterType((*MsgCreateGaugeResponse)(nil), "merlins.incentives.MsgCreateGaugeResponse")
	proto.RegisterType((*MsgAddToGauge)(nil), "merlins.incentives.MsgAddToGauge")
	proto.RegisterType((*MsgAddToGaugeResponse)(nil), "merlins.incentives.MsgAddToGaugeResponse")
}

func init() { proto.RegisterFile("merlins/incentives/tx.proto", fileDescriptor_8ea120e22291556e) }
...
var fileDescriptor_8ea120e22291556e = []byte{
	...
	0xd9, 0x19, 0xc1, 0x44, 0x13, 0x6e, 0x2e, 0x31, 0x86, 0x03, 0x11, 0x1b, 0x12, 0x13, 0x12, 0xd3,
	...
	0x37, 0xa9, 0xae, 0xf5, 0xcb, 0x3f, 0x01, 0x00, 0x00, 0xff, 0xff, 0xb9, 0xbc, 0x37, 0x0f, 0xdd,
	0x04, 0x00, 0x00,
}
...
func (c *msgClient) CreateGauge(ctx context.Context, in *MsgCreateGauge, opts ...grpc.CallOption) (*MsgCreateGaugeResponse, error) {
	...
	err := c.cc.Invoke(ctx, "/merlins.incentives.Msg/CreateGauge", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *msgClient) AddToGauge(ctx context.Context, in *MsgAddToGauge, opts ...grpc.CallOption) (*MsgAddToGaugeResponse, error) {
	...
	err := c.cc.Invoke(ctx, "/merlins.incentives.Msg/AddToGauge", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func _Msg_CreateGauge_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/merlins.incentives.Msg/CreateGauge",
	}
...
func _Msg_AddToGauge_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/merlins.incentives.Msg/AddToGauge",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
...
var _Msg_serviceDesc = grpc.ServiceDesc{
	ServiceName: "merlins.incentives.Msg",
	...
	Metadata: "merlins/incentives/tx.proto",
}
