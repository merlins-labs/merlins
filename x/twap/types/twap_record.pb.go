...
// source: merlins/twap/v1beta1/twap_record.proto
...
func init() {
	proto.RegisterType((*TwapRecord)(nil), "merlins.twap.v1beta1.TwapRecord")
}

func init() {
	proto.RegisterFile("merlins/twap/v1beta1/twap_record.proto", fileDescriptor_dbf5c78678e601aa)
}
