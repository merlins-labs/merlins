...
// source: merlins/twap/v1beta1/genesis.proto
...
func init() {
	proto.RegisterType((*Params)(nil), "merlins.twap.v1beta1.Params")
	proto.RegisterType((*GenesisState)(nil), "merlins.twap.v1beta1.GenesisState")
}

func init() {
	proto.RegisterFile("merlins/twap/v1beta1/genesis.proto", fileDescriptor_3f4bdf49b69bd63c)
}
