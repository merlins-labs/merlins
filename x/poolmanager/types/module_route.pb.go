...
// source: merlins/poolmanager/v1beta1/module_route.proto
...
type ModuleRoute struct {
	...
	PoolType PoolType `protobuf:"varint,1,opt,name=pool_type,json=poolType,proto3,enum=merlins.poolmanager.v1beta1.PoolType" json:"pool_type,omitempty"`
...
func init() {
	proto.RegisterEnum("merlins.poolmanager.v1beta1.PoolType", PoolType_name, PoolType_value)
	proto.RegisterType((*ModuleRoute)(nil), "merlins.poolmanager.v1beta1.ModuleRoute")
}

func init() {
	proto.RegisterFile("merlins/poolmanager/v1beta1/module_route.proto", fileDescriptor_96bfcc7b6d387cee)
}
