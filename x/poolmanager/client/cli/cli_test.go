...
import (
	...
	poolmanagertestutil "github.com/merlins-labs/merlins/v17/x/poolmanager/client/testutil"
...
// 	}{
// 		{
// 			"query pool estimate swap exact amount in", // merlins query poolmanager estimate-swap-exact-amount-in 1 cosmos1n8skk06h3kyh550ad9qketlfhc2l5dsdevd3hq 10.0stake --swap-route-pool-ids=1 --swap-route-denoms=node0token
// 			[]string{
// 				"1",
	...
	testCases := []struct {
		...
		},
		{
			...
			fmt.Sprintf(`
			{
			  ...
			  "%s": "0.001",
			  "%s": "0.001",
			  "%s": "fury1fqlr98d45v5ysqgp6h56kpujcj4cvsjnjq9nck"
			}
