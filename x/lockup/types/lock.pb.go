...
// source: merlins/lockup/lock.proto
...
type QueryCondition struct {
	...
	LockQueryType LockQueryType `protobuf:"varint,1,opt,name=lock_query_type,json=lockQueryType,proto3,enum=merlins.lockup.LockQueryType" json:"lock_query_type,omitempty"`
...
func init() {
	proto.RegisterEnum("merlins.lockup.LockQueryType", LockQueryType_name, LockQueryType_value)
	proto.RegisterType((*PeriodLock)(nil), "merlins.lockup.PeriodLock")
	proto.RegisterType((*QueryCondition)(nil), "merlins.lockup.QueryCondition")
	proto.RegisterType((*SyntheticLock)(nil), "merlins.lockup.SyntheticLock")
}

func init() { proto.RegisterFile("merlins/lockup/lock.proto", fileDescriptor_7e9d7527a237b489) }
...
var fileDescriptor_7e9d7527a237b489 = []byte{
	...
	,
}
