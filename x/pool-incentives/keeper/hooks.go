...
func (h Hooks) AfterDistributeMintedCoin(ctx sdk.Context) {
	...
	// the distribution uses the remaining 80% to calculate–which means if the community pool is set to receive 10% of newly minted FURY, community pool is 8% of the total inflation.
