...
// source: merlins/pool-incentives/v1beta1/gov.proto
...
func init() {
	proto.RegisterType((*ReplacePoolIncentivesProposal)(nil), "merlins.poolincentives.v1beta1.ReplacePoolIncentivesProposal")
	proto.RegisterType((*UpdatePoolIncentivesProposal)(nil), "merlins.poolincentives.v1beta1.UpdatePoolIncentivesProposal")
}

func init() {
	proto.RegisterFile("merlins/pool-incentives/v1beta1/gov.proto", fileDescriptor_96caede426ba9516)
}
...
var fileDescriptor_96caede426ba9516 = []byte{
	...
	0x87, 0x1a, 0xa5, 0x9b, 0x93, 0x98, 0x54, 0x0c, 0xe3, 0xe8, 0x97, 0x19, 0x9a, 0xeb, 0x57, 0x60,
	0xa4, 0xb0, 0x92, 0xca, 0x82, 0xd4, 0xe2, 0x24, 0x36, 0x70, 0xaa, 0x32, 0x06, 0x04, 0x00, 0x00,
	0xff, 0xff, 0x06, 0x8a, 0x63, 0xed, 0x18, 0x03, 0x00, 0x00,
}
