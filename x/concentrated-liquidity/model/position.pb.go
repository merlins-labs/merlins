...
// source: merlins/concentrated-liquidity/position.proto
...
import (
	...
	types2 "github.com/merlins-labs/merlins/v17/x/lockup/types"
	io "io"
	math "math"
	math_bits "math/bits"
	time "time"
...
func init() {
	proto.RegisterType((*Position)(nil), "merlins.concentratedliquidity.v1beta1.Position")
	proto.RegisterType((*FullPositionBreakdown)(nil), "merlins.concentratedliquidity.v1beta1.FullPositionBreakdown")
	proto.RegisterType((*PositionWithPeriodLock)(nil), "merlins.concentratedliquidity.v1beta1.PositionWithPeriodLock")
}

func init() {
	proto.RegisterFile("merlins/concentrated-liquidity/position.proto", fileDescriptor_ffdfd7b30d37d326)
}
