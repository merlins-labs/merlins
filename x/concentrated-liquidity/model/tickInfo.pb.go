...
// source: merlins/concentrated-liquidity/tickInfo.proto
...
func init() {
	proto.RegisterType((*TickInfo)(nil), "merlins.concentratedliquidity.v1beta1.TickInfo")
	proto.RegisterType((*UptimeTrackers)(nil), "merlins.concentratedliquidity.v1beta1.UptimeTrackers")
	proto.RegisterType((*UptimeTracker)(nil), "merlins.concentratedliquidity.v1beta1.UptimeTracker")
}

func init() {
	proto.RegisterFile("merlins/concentrated-liquidity/tickInfo.proto", fileDescriptor_1ccb7e45032b943a)
}
...
var fileDescriptor_1ccb7e45032b943a = []byte{
	...
	0x90, 0x26, 0xb4, 0xab, 0x88, 0x1e, 0xe3, 0xe2, 0x2a, 0x88, 0x0b, 0xa1, 0x5e, 0x44, 0x09, 0x93,
	...
	0xb5, 0xf8, 0x4e, 0xf7, 0x7f, 0x07, 0x00, 0x00, 0xff, 0xff, 0xfc, 0x27, 0xc8, 0x48, 0x50, 0x04,
	0x00, 0x00,
}
