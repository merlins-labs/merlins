...
// source: merlins/concentrated-liquidity/pool.proto
...
import (
	...
	github_com_merlins_labs_merlins_osmomath "github.com/osmosis-labs/osmosis/osmomath"
	io "io"
	math "math"
	math_bits "math/bits"
	time "time"
...
type Pool struct {
	...
	CurrentSqrtPrice     github_com_merlins_labs_merlins_osmomath.BigDec `protobuf:"bytes,8,opt,name=current_sqrt_price,json=currentSqrtPrice,proto3,customtype=github.com/osmosis-labs/osmosis/osmomath.BigDec" json:"current_sqrt_price" yaml:"spot_price"`
...
func init() {
	proto.RegisterType((*Pool)(nil), "merlins.concentratedliquidity.v1beta1.Pool")
}

func init() {
	proto.RegisterFile("merlins/concentrated-liquidity/pool.proto", fileDescriptor_3526ea5373d96c9a)
}
...
var fileDescriptor_3526ea5373d96c9a = []byte{
	...
	0xb8, 0x89, 0xab, 0x07, 0xa1, 0xb7, 0x2e, 0x52, 0x10, 0x0a, 0x2d, 0x69, 0x45, 0x10, 0x21, 0xcc,
	...
	0xec, 0xce, 0x88, 0x1e, 0x9e, 0xff, 0x0e, 0x00, 0x00, 0xff, 0xff, 0xf8, 0xac, 0x29, 0xa9, 0xf3,
	0x04, 0x00, 0x00,
}
