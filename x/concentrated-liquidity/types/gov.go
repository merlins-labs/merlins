...
func init() {
	...
	govtypes.RegisterProposalTypeCodec(&CreateConcentratedLiquidityPoolsProposal{}, "merlins/CreateCLPoolsProposal")
	govtypes.RegisterProposalType(ProposalTypeTickSpacingDecrease)
	govtypes.RegisterProposalTypeCodec(&TickSpacingDecreaseProposal{}, "merlins/TickSpacingDecreaseProposal")
}
