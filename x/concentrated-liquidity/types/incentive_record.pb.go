...
// source: merlins/concentrated-liquidity/incentive_record.proto
...
func init() {
	proto.RegisterType((*IncentiveRecord)(nil), "merlins.concentratedliquidity.v1beta1.IncentiveRecord")
	proto.RegisterType((*IncentiveRecordBody)(nil), "merlins.concentratedliquidity.v1beta1.IncentiveRecordBody")
}

func init() {
	proto.RegisterFile("merlins/concentrated-liquidity/incentive_record.proto", fileDescriptor_9d38bf94e42ee434)
}
