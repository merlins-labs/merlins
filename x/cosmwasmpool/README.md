...
- [transmuter](https://github.com/merlins-labs/transmuter)
...
Despite code upload being permissioned by governance on Merlins, it is allowed to be done by a certain
set of addresses:

```bash
merlins q wasm params
code_upload_access:
  address: ""
  addresses:
