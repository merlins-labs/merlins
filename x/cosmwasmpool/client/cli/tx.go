...
import (
	...
	"github.com/merlins-labs/merlins/v17/x/cosmwasmpool/cosmwasm/msg"
...
func NewCreateCWPoolCmd() (*osmocli.TxCliDesc, *model.MsgCreateCosmWasmPool) {
	return &osmocli.TxCliDesc{
		...
		Example:          "merlins tx cosmwasmpool create-pool 1 uion,ufury --from lo-test1 --keyring-backend test --chain-id localmerlins --fees 875ufury -b=block",
		NumArgs:          2,
...
func NewCmdUploadCodeIdAndWhitelistProposal() *cobra.Command {
	cmd := &cobra.Command{
		...
		Example: "merlins tx gov submit-proposal upload-code-id-and-whitelist x/cosmwasmpool/bytecode/transmuter.wasm --from lo-test1 --keyring-backend test --title \"Test\" --description \"Test\" -b=block --chain-id localmerlins --fees=100000ufury --gas=20000000",
