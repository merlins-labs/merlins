...
import (
	...
	types "github.com/merlins-labs/merlins/v17/x/cosmwasmpool/types"
...
func init() {
	proto.RegisterType((*ParamsRequest)(nil), "merlins.cosmwasmpool.v1beta1.ParamsRequest")
	proto.RegisterType((*ParamsResponse)(nil), "merlins.cosmwasmpool.v1beta1.ParamsResponse")
	proto.RegisterType((*PoolsRequest)(nil), "merlins.cosmwasmpool.v1beta1.PoolsRequest")
	proto.RegisterType((*PoolsResponse)(nil), "merlins.cosmwasmpool.v1beta1.PoolsResponse")
	proto.RegisterType((*ContractInfoByPoolIdRequest)(nil), "merlins.cosmwasmpool.v1beta1.ContractInfoByPoolIdRequest")
	proto.RegisterType((*ContractInfoByPoolIdResponse)(nil), "merlins.cosmwasmpool.v1beta1.ContractInfoByPoolIdResponse")
}

func init() {
	proto.RegisterFile("merlins/cosmwasmpool/v1beta1/query.proto", fileDescriptor_733c758985c393b2)
}
...
func (c *queryClient) Pools(ctx context.Context, in *PoolsRequest, opts ...grpc.CallOption) (*PoolsResponse, error) {
	...
	err := c.cc.Invoke(ctx, "/merlins.cosmwasmpool.v1beta1.Query/Pools", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *queryClient) Params(ctx context.Context, in *ParamsRequest, opts ...grpc.CallOption) (*ParamsResponse, error) {
	...
	err := c.cc.Invoke(ctx, "/merlins.cosmwasmpool.v1beta1.Query/Params", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *queryClient) ContractInfoByPoolId(ctx context.Context, in *ContractInfoByPoolIdRequest, opts ...grpc.CallOption) (*ContractInfoByPoolIdResponse, error) {
	...
	err := c.cc.Invoke(ctx, "/merlins.cosmwasmpool.v1beta1.Query/ContractInfoByPoolId", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func _Query_Pools_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/merlins.cosmwasmpool.v1beta1.Query/Pools",
	}
...
func _Query_Params_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/merlins.cosmwasmpool.v1beta1.Query/Params",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
...
func _Query_ContractInfoByPoolId_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/merlins.cosmwasmpool.v1beta1.Query/ContractInfoByPoolId",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
...
var _Query_serviceDesc = grpc.ServiceDesc{
	ServiceName: "merlins.cosmwasmpool.v1beta1.Query",
	...
	Metadata: "merlins/cosmwasmpool/v1beta1/query.proto",
}
