...
// source: merlins/cosmwasmpool/v1beta1/model/tx.proto
...
func init() {
	proto.RegisterType((*MsgCreateCosmWasmPool)(nil), "merlins.cosmwasmpool.v1beta1.MsgCreateCosmWasmPool")
	proto.RegisterType((*MsgCreateCosmWasmPoolResponse)(nil), "merlins.cosmwasmpool.v1beta1.MsgCreateCosmWasmPoolResponse")
}

func init() {
	proto.RegisterFile("merlins/cosmwasmpool/v1beta1/model/tx.proto", fileDescriptor_2ff1ac8555d314d1)
}
...
var fileDescriptor_2ff1ac8555d314d1 = []byte{
	...
	0x10, 0xc6, 0xb3, 0x80, 0x1c, 0xb1, 0x82, 0x20, 0x56, 0x80, 0x22, 0x0b, 0xec, 0xc8, 0x34, 0x41,
	0x11, 0x5e, 0x85, 0x14, 0x20, 0xe8, 0x9c, 0x34, 0x29, 0x22, 0x21, 0x37, 0x48, 0x34, 0xd1, 0xda,
	0x5e, 0x19, 0x4b, 0x5e, 0x4f, 0xe4, 0x59, 0x42, 0x78, 0x01, 0x6a, 0x1a, 0xde, 0x84, 0x87, 0xb8,
	0x32, 0xe5, 0x55, 0xd6, 0xc9, 0x79, 0x83, 0x3c, 0xc1, 0xc9, 0x7f, 0x72, 0x97, 0x3b, 0x45, 0x57,
	0x5c, 0x37, 0x9e, 0xf9, 0x7d, 0xe3, 0x4f, 0xdf, 0x0e, 0x1d, 0x01, 0x2a, 0xc0, 0x04, 0x79, 0x08,
	...
	0x00, 0x00, 0xff, 0xff, 0x12, 0xe3, 0x2d, 0x3b, 0x72, 0x02, 0x00, 0x00,
}
...
func (c *msgCreatorClient) CreateCosmWasmPool(ctx context.Context, in *MsgCreateCosmWasmPool, opts ...grpc.CallOption) (*MsgCreateCosmWasmPoolResponse, error) {
	...
	err := c.cc.Invoke(ctx, "/merlins.cosmwasmpool.v1beta1.MsgCreator/CreateCosmWasmPool", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func _MsgCreator_CreateCosmWasmPool_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/merlins.cosmwasmpool.v1beta1.MsgCreator/CreateCosmWasmPool",
	}
...
var _MsgCreator_serviceDesc = grpc.ServiceDesc{
	ServiceName: "merlins.cosmwasmpool.v1beta1.MsgCreator",
	...
	Metadata: "merlins/cosmwasmpool/v1beta1/model/tx.proto",
}
