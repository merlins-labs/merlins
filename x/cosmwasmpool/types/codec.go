...
func RegisterCodec(cdc *codec.LegacyAmino) {
	...
	// gov proposals
	cdc.RegisterConcrete(&UploadCosmWasmPoolCodeAndWhiteListProposal{}, "merlins/upload-cw-pool-code", nil)
	cdc.RegisterConcrete(&MigratePoolContractsProposal{}, "merlins/migrate-pool-contracts", nil)
}
