...
func init() {
	...
	govtypes.RegisterProposalTypeCodec(&UploadCosmWasmPoolCodeAndWhiteListProposal{}, "merlins/UploadCosmWasmPoolCodeAndWhiteListProposal")
	govtypes.RegisterProposalType(ProposalTypeMigratePoolContractsProposal)
	govtypes.RegisterProposalTypeCodec(&MigratePoolContractsProposal{}, "merlins/MigratePoolContractsProposal")
}
