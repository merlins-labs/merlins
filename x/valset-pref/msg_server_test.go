...
func (s *KeeperTestSuite) TestDelegateBondedTokens() {
	...
	tests := []struct {
	...
	}{
		{
			...
			expectedUnlockedOsmo: sdk.NewCoin(appParams.BaseCoinUnit, sdk.NewInt(60_000_000)), // delegator has 100fury and creates 5 locks 10fury each, forceUnlock only 1 lock
