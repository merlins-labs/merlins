...
func NewSetValSetCmd() (*osmocli.TxCliDesc, *types.MsgSetValidatorSetPreference) {
	return &osmocli.TxCliDesc{
		...
		Example:          "merlins tx valset-pref set-valset fury1... furyvaloper1abc...,furyvaloper1def...  0.56,0.44",
		NumArgs:          3,
...
func NewDelValSetCmd() (*osmocli.TxCliDesc, *types.MsgDelegateToValidatorSet) {
	return &osmocli.TxCliDesc{
		...
		Example: "merlins tx valset-pref delegate-valset fury1... 100stake",
		NumArgs: 2,
...
func NewUnDelValSetCmd() (*osmocli.TxCliDesc, *types.MsgUndelegateFromValidatorSet) {
	return &osmocli.TxCliDesc{
		...
		Example: "merlins tx valset-pref undelegate-valset fury1... 100stake",
		NumArgs: 2,
...
func NewReDelValSetCmd() (*osmocli.TxCliDesc, *types.MsgRedelegateValidatorSet) {
	return &osmocli.TxCliDesc{
		...
		Example:          "merlins tx valset-pref redelegate-valset  fury1... furyvaloper1efg...,furyvaloper1hij...  0.56,0.44",
		NumArgs:          3,
...
func NewWithRewValSetCmd() (*osmocli.TxCliDesc, *types.MsgWithdrawDelegationRewards) {
	return &osmocli.TxCliDesc{
		...
		Example: "merlins tx valset-pref withdraw-valset fury1...",
		NumArgs: 1,
