...
const (
	// msgs
	setHotRoutes             = "merlins/MsgSetHotRoutes"
	setDeveloperAccount      = "merlins/MsgSetDeveloperAccount"
	setMaxPoolPointsPerTx    = "merlins/MsgSetMaxPoolPointsPerTx"
	setMaxPoolPointsPerBlock = "merlins/MsgSetMaxPoolPointsPerBlock"
	setInfoByPoolType        = "merlins/MsgSetInfoByPoolType"
	setBaseDenoms            = "merlins/MsgSetBaseDenoms"

	// proposals
	setProtoRevEnabledProposal      = "merlins/SetProtoRevEnabledProposal"
	setProtoRevAdminAccountProposal = "merlins/SetProtoRevAdminAccountProposal"
)
