	...
	cases := []struct {
	...
	}{
		{
			...
			expectedRoutes: [][]TestRoute{
				...
				{
					{PoolId: 25, InputDenom: types.MerlinsDenomination, OutputDenom: "Atom"},
					{PoolId: 1, InputDenom: "Atom", OutputDenom: "akash"},
					{PoolId: 7, InputDenom: "akash", OutputDenom: types.MerlinsDenomination},
				},
			},
		},
		{
			...
			expectedRoutes: [][]TestRoute{
				{
					...
					{PoolId: 10, InputDenom: "bitcoin", OutputDenom: types.MerlinsDenomination},
				},
			},
		},
		{
			...
			expectedRoutes: [][]TestRoute{
				{
					{PoolId: 9, InputDenom: types.MerlinsDenomination, OutputDenom: "ethereum"},
		...
		},
		{
			...
			inputDenom:     types.MerlinsDenomination,
			outputDenom:    "Atom",
			poolID:         25,
			expectedRoutes: [][]TestRoute{},
		},
		{
			...
			inputDenom:  "usdc",
			outputDenom: types.MerlinsDenomination,
			poolID:      29,
			expectedRoutes: [][]TestRoute{
				{
					{PoolId: 29, InputDenom: types.MerlinsDenomination, OutputDenom: "usdc"},
					{PoolId: 40, InputDenom: "usdc", OutputDenom: "busd"},
					{PoolId: 30, InputDenom: "busd", OutputDenom: types.MerlinsDenomination},
				},
			},
		},
	}
...
func (s *KeeperTestSuite) TestBuildHighestLiquidityRoute() {
	cases := []struct {
	...
	}{
		{
			...
			swapDenom:   types.MerlinsDenomination,
			swapIn:      "Atom",
			swapOut:     "akash",
			poolId:      1,
			expectedRoute: []TestRoute{
				{7, types.MerlinsDenomination, "akash"},
				{1, "akash", "Atom"},
				{25, "Atom", types.MerlinsDenomination},
			},
			hasRoute:                 true,
		...
		},
		{
			...
			poolId:      1,
			expectedRoute: []TestRoute{
				{25, types.MerlinsDenomination, "Atom"},
				{1, "Atom", "akash"},
				{7, "akash", types.MerlinsDenomination},
			},
			hasRoute:                 true,
			expectedRoutePointPoints: 6,
		},
		...
		},
		{
			...
			swapDenom:   "Atom",
			swapIn:      types.MerlinsDenomination,
			swapOut:     "akash",
			poolId:      7,
			expectedRoute: []TestRoute{
				{1, "Atom", "akash"},
		...
		},
		{
			...
			swapDenom:   "Atom",
			swapIn:      "akash",
			swapOut:     types.MerlinsDenomination,
			poolId:      7,
			expectedRoute: []TestRoute{
				{25, "Atom", types.MerlinsDenomination},
				{7, types.MerlinsDenomination, "akash"},
	...
	cases := []struct {
		...
		},
		{
			...
			expectedRoutes: [][]TestRoute{
				{
					{34, "Atom", "test/1"},
					{35, "test/1", types.MerlinsDenomination},
					{36, types.MerlinsDenomination, "test/2"},
					{10, "test/2", "Atom"},
				},
			},
			expectedStepSize:        []sdk.Int{sdk.NewInt(1_000_000)},
