...
func (s *KeeperTestSuite) TestGetProtoRevNumberOfTrades() {
	...
	err = s.App.AppKeepers.ProtoRevKeeper.UpdateStatistics(s.Ctx, poolmanagertypes.SwapAmountInRoutes{}, types.MerlinsDenomination, sdk.NewInt(10000))
	s.Require().NoError(err)
...
func (s *KeeperTestSuite) TestGetProtoRevAllProfits() {
	...
	// Pseudo execute a trade
	err = s.App.AppKeepers.ProtoRevKeeper.UpdateStatistics(s.Ctx, poolmanagertypes.SwapAmountInRoutes{}, types.MerlinsDenomination, sdk.NewInt(9000))
	s.Require().NoError(err)
	...
	fury := sdk.NewCoin(types.MerlinsDenomination, sdk.NewInt(9000))
	...
	fury = sdk.NewCoin(types.MerlinsDenomination, sdk.NewInt(19000))
	s.Require().Contains(res.Profits, atom)
	s.Require().Contains(res.Profits, fury)
}
...
func (s *KeeperTestSuite) TestGetProtoRevStatisticsByRoute() {
	...
	err = s.App.AppKeepers.ProtoRevKeeper.UpdateStatistics(s.Ctx, poolmanagertypes.SwapAmountInRoutes{{TokenOutDenom: "", PoolId: 1}, {TokenOutDenom: "", PoolId: 2}, {TokenOutDenom: "", PoolId: 3}}, types.MerlinsDenomination, sdk.NewInt(80000))
	s.Require().NoError(err)
	...
	furyCoin := sdk.NewCoin(types.MerlinsDenomination, sdk.NewInt(80000))
...
func (s *KeeperTestSuite) TestGetProtoRevAllRouteStatistics() {
	...
	// Pseudo execute a trade
	err = s.App.AppKeepers.ProtoRevKeeper.UpdateStatistics(s.Ctx, poolmanagertypes.SwapAmountInRoutes{{TokenOutDenom: "", PoolId: 1}, {TokenOutDenom: "", PoolId: 2}, {TokenOutDenom: "", PoolId: 3}}, types.MerlinsDenomination, sdk.NewInt(10000))
	s.Require().NoError(err)
	...
	furyCoin := sdk.NewCoin(types.MerlinsDenomination, sdk.NewInt(10000))
	...
	furyCoin = sdk.NewCoin(types.MerlinsDenomination, sdk.NewInt(90000))
	s.Require().Contains(res.Statistics[0].Profits, furyCoin)

	// Pseudo execute another trade on a different route
	err = s.App.AppKeepers.ProtoRevKeeper.UpdateStatistics(s.Ctx, poolmanagertypes.SwapAmountInRoutes{{TokenOutDenom: "", PoolId: 1}, {TokenOutDenom: "", PoolId: 2}, {TokenOutDenom: "", PoolId: 4}}, types.MerlinsDenomination, sdk.NewInt(70000))
	s.Require().NoError(err)
	...
	furyCoin = sdk.NewCoin(types.MerlinsDenomination, sdk.NewInt(70000))
