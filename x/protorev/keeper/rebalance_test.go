...
var fourPoolRoute = poolmanagertypes.SwapAmountInRoutes{
	...
	poolmanagertypes.SwapAmountInRoute{
		PoolId:        35,
		TokenOutDenom: types.MerlinsDenomination,
	},
	poolmanagertypes.SwapAmountInRoute{
		PoolId:        36,
...
func (s *KeeperTestSuite) TestExecuteTrade() {
	...
	tests := []struct {
	...
	}{
		{
			...
			arbDenom:            types.MerlinsDenomination,
			expectPass:          true,
...
func (s *KeeperTestSuite) TestUpdateSearchRangeIfNeeded() {
	...
	s.Run("Extended search on CL pools", func() {
		...
		clPool := s.PrepareCustomConcentratedPool(s.TestAccs[0], "atom", "ufury", apptesting.DefaultTickSpacing, sdk.ZeroDec())
		fundCoins := sdk.NewCoins(sdk.NewCoin("atom", sdk.NewInt(10_000_000_000_000)), sdk.NewCoin("ufury", sdk.NewInt(10_000_000_000_000)))
		s.FundAcc(s.TestAccs[0], fundCoins)
		s.CreateFullRangePosition(clPool, fundCoins)

		clPool2 := s.PrepareCustomConcentratedPool(s.TestAccs[0], "atom", "ufury", apptesting.DefaultTickSpacing, sdk.ZeroDec())
		fundCoins = sdk.NewCoins(sdk.NewCoin("atom", sdk.NewInt(20_000_000_000_000)), sdk.NewCoin("ufury", sdk.NewInt(10_000_000_000_000)))
		s.FundAcc(s.TestAccs[0], fundCoins)
	...
	s.Run("Reduced search on CL pools", func() {
		stablePool := s.createStableswapPool(
			sdk.NewCoins(
				sdk.NewCoin("ufury", sdk.NewInt(25_000_000_000)),
		...
		// Create two massive CL pools with a massive arb
		clPool := s.PrepareCustomConcentratedPool(s.TestAccs[0], "eth", "ufury", apptesting.DefaultTickSpacing, sdk.ZeroDec())
		fundCoins := sdk.NewCoins(sdk.NewCoin("eth", sdk.NewInt(10_000_000_000_000)), sdk.NewCoin("ufury", sdk.NewInt(10_000_000_000_000)))
		s.FundAcc(s.TestAccs[0], fundCoins)
		s.CreateFullRangePosition(clPool, fundCoins)
