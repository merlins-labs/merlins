...
import (
	...
	types "github.com/merlins-labs/merlins/v17/x/superfluid/types"
)
...
func (k Keeper) ConvertGammSharesToFuryAndStake(
	...
	return k.convertGammSharesToFuryAndStake(ctx, sender, valAddr, poolIdLeaving, exitCoins, minAmtToStake, originalSuperfluidValAddr)
}
