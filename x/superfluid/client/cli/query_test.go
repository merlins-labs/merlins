...
func (s *QueryTestSuite) TestQueriesNeverAlterState() {
	...
	testCases := []struct {
		...
		// 	"/merlins.superfluid.Query/EstimateSuperfluidDelegatedAmountByValidatorDenom",
		...
		{
			"Query params",
			"/merlins.superfluid.Query/Params",
			&types.QueryParamsRequest{},
			&types.QueryParamsResponse{},
		},
		{
			"Query sfs delegation amount",
			"/merlins.superfluid.Query/SuperfluidDelegationAmount",
		...
		},
		{
			...
			"/merlins.superfluid.Query/SuperfluidDelegationsByDelegator",
		...
		},
		{
			...
			"/merlins.superfluid.Query/SuperfluidDelegationsByValidatorDenom",
		...
		},
		{
			...
			"/merlins.superfluid.Query/SuperfluidUndelegationsByDelegator",
		...
		},
		{
			...
			"/merlins.superfluid.Query/TotalDelegationByDelegator",
		...
		},
		{
			...
			"/merlins.superfluid.Query/TotalSuperfluidDelegations",
