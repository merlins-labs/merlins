...
// The Osmo-Equivalent-Multiplier Record for epoch N refers to the fury worth we
...
func init() {
	...
	proto.RegisterType((*OsmoEquivalentMultiplierRecord)(nil), "merlins.superfluid.OsmoEquivalentMultiplierRecord")
