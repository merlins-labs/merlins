...
func init() {
	...
	govtypes.RegisterProposalTypeCodec(&SetSuperfluidAssetsProposal{}, "merlins/SetSuperfluidAssetsProposal")
	govtypes.RegisterProposalType(ProposalTypeRemoveSuperfluidAssets)
	govtypes.RegisterProposalTypeCodec(&RemoveSuperfluidAssetsProposal{}, "merlins/RemoveSuperfluidAssetsProposal")
	govtypes.RegisterProposalType(ProposalTypeUpdateUnpoolWhitelist)
	govtypes.RegisterProposalTypeCodec(&UpdateUnpoolWhiteListProposal{}, "merlins/UpdateUnpoolWhiteListProposal")
}
