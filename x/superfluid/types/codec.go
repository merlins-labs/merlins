...
func RegisterCodec(cdc *codec.LegacyAmino) {
	...
	cdc.RegisterConcrete(&MsgAddToConcentratedLiquiditySuperfluidPosition{}, "merlins/add-to-cl-superfluid-position", nil)
	cdc.RegisterConcrete(&MsgUnbondConvertAndStake{}, "merlins/unbond-convert-and-stake", nil)
}
