...
<img src="https://raw.githubusercontent.com/merlins-labs/merlins/main/x/superfluid/superfluiddiagram.png" height="300"/>
...
- Calculate `Osmo` to delegate on behalf of this `lock`, as
  ...
  - If this amount is less than 0.000001 `Osmo` (`1 ufury`) reject
...
message AssetMultiplierResponse {
  OsmoEquivalentMultiplierRecord fury_equivalent_multiplier = 1;
};
...
The Osmo-Equivalent-Multiplier Record for epoch N refers to the fury
