...
func NewStableSwapAdjustScalingFactorsCmd() *cobra.Command {
	cmd := osmocli.TxCliDesc{
		...
		Example:          "merlins adjust-scaling-factors --pool-id=1 --scaling-factors=\"100, 100\"",
		NumArgs:          0,
...
Sample proposal file:
{
	...
	"description": "Change scaling factor controller address from furyXXX to furyYYY"
	"pool-id": 1,
	"controller-address": "furyYYY"
}
>>> merlins tx gov submit-proposal set-scaling-factor-controller-proposal \
