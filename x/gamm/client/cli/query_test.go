...
func (s *QueryTestSuite) TestQueriesNeverAlterState() {
	...
	testCases := []struct {
		...
		{
			"Query estimate for join pool shares with no swap",
			"/merlins.gamm.v1beta1.Query/CalcJoinPoolShares",
		...
		},
		{
			...
			"/merlins.gamm.v1beta1.Query/CalcExitPoolCoinsFromShares",
