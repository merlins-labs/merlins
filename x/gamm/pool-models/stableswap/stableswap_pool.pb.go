...
// source: merlins/gamm/pool-models/stableswap/stableswap_pool.proto
...
func init() {
	proto.RegisterType((*PoolParams)(nil), "merlins.gamm.poolmodels.stableswap.v1beta1.PoolParams")
	proto.RegisterType((*Pool)(nil), "merlins.gamm.poolmodels.stableswap.v1beta1.Pool")
}

func init() {
	proto.RegisterFile("merlins/gamm/pool-models/stableswap/stableswap_pool.proto", fileDescriptor_ae0f054436f9999a)
}
