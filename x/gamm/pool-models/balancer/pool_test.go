...
func TestUpdateIntermediaryPoolAssetsLiquidity(t *testing.T) {
	const (
		ufuryValueOriginal = 1_000_000_000_000
	...
	testCases := []struct {
	...
	}{
		{
			...
			newLiquidity: sdk.NewCoins(
				sdk.NewInt64Coin("ufury", 1_000),
				sdk.NewInt64Coin("atom", 2_000),
				sdk.NewInt64Coin("ion", 3_000)),
			poolAssets: map[string]balancer.PoolAsset{
				"ufury": {
					Token:  sdk.NewInt64Coin("ufury", ufuryValueOriginal),
...
func TestCalcJoinSingleAssetTokensIn(t *testing.T) {
	testCases := []struct {
		...
		},
		{
			...
			spreadFactor: sdk.MustNewDecFromStr("0"),
			poolAssets:   oneTrillionEvenPoolAssets,
			tokensIn:     sdk.NewCoins(sdk.NewInt64Coin("ufury", 50_000), sdk.NewInt64Coin("uatom", 50_000)),
		...
		},
		{
			...
			poolAssets: []balancer.PoolAsset{
				{
					Token:  sdk.NewInt64Coin("ufury", 2_000_000_000),
			...
			tokensIn:     sdk.NewCoins(sdk.NewInt64Coin("ufury", 50_000), sdk.NewInt64Coin("uatom", 100_000)),
		...
		},
		{
			...
			tokensIn:     sdk.NewCoins(sdk.NewInt64Coin("ufury", 50_000), sdk.NewInt64Coin(doesNotExistDenom, 50_000)),
