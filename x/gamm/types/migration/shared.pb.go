...
// source: merlins/gamm/v1beta1/shared.proto
...
func init() {
	proto.RegisterType((*MigrationRecords)(nil), "merlins.gamm.v1beta1.MigrationRecords")
	proto.RegisterType((*BalancerToConcentratedPoolLink)(nil), "merlins.gamm.v1beta1.BalancerToConcentratedPoolLink")
}

func init() { proto.RegisterFile("merlins/gamm/v1beta1/shared.proto", fileDescriptor_ecfa270aa4b2c075) }
...
var fileDescriptor_ecfa270aa4b2c075 = []byte{
	...
	0x54, 0x05, 0xa1, 0x63, 0x9d, 0x04, 0x05, 0x29, 0x9d, 0x5c, 0xc2, 0xdd, 0xe5, 0x4c, 0x8f, 0x5e,
	...
	0x13, 0x90, 0xc1, 0xdc, 0x13, 0x02, 0x00, 0x00,
}
