...
func RegisterLegacyAminoCodec(cdc *codec.LegacyAmino) {
	...
	cdc.RegisterConcrete(&CreateConcentratedLiquidityPoolsAndLinktoCFMMProposal{}, "merlins/gamm/create-cl-pool-and-cfmm-link", nil)
	cdc.RegisterConcrete(&SetScalingFactorControllerProposal{}, "merlins/gamm/scaling-factor-controller", nil)
}
