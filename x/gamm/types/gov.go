...
func init() {
	...
	govtypes.RegisterProposalTypeCodec(&UpdateMigrationRecordsProposal{}, "merlins/UpdateMigrationRecordsProposal")
	govtypes.RegisterProposalType(ProposalTypeReplaceMigrationRecords)
	govtypes.RegisterProposalTypeCodec(&ReplaceMigrationRecordsProposal{}, "merlins/ReplaceMigrationRecordsProposal")
	govtypes.RegisterProposalType(ProposalTypeCreateConcentratedLiquidityPoolAndLinktoCFMM)
	govtypes.RegisterProposalTypeCodec(&CreateConcentratedLiquidityPoolsAndLinktoCFMMProposal{}, "merlins/CreateConcentratedLiquidityPoolsAndLinktoCFMMProposal")
	govtypes.RegisterProposalType(ProposalTypeSetScalingFactorController)
	govtypes.RegisterProposalTypeCodec(&SetScalingFactorControllerProposal{}, "merlins/SetScalingFactorControllerProposal")
}
