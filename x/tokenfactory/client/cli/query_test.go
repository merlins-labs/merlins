...
func (s *QueryTestSuite) TestQueriesNeverAlterState() {
	testCases := []struct {
	...
	}{
		{
			...
			"/merlins.tokenfactory.v1beta1.Query/DenomAuthorityMetadata",
