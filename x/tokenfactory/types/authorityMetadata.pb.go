...
// source: merlins/tokenfactory/v1beta1/authorityMetadata.proto
...
type DenomAuthorityMetadata struct {
	// Can be empty for no admin, or a valid merlins address
...
func init() {
	proto.RegisterType((*DenomAuthorityMetadata)(nil), "merlins.tokenfactory.v1beta1.DenomAuthorityMetadata")
}

func init() {
	proto.RegisterFile("merlins/tokenfactory/v1beta1/authorityMetadata.proto", fileDescriptor_99435de88ae175f7)
}
...
var fileDescriptor_99435de88ae175f7 = []byte{
	...
	0x19, 0x9a, 0xeb, 0x57, 0xa0, 0x86, 0x44, 0x49, 0x65, 0x41, 0x6a, 0x71, 0x12, 0x1b, 0xd8, 0x89,
	0xc6, 0x80, 0x00, 0x00, 0x00, 0xff, 0xff, 0x2d, 0xa0, 0x40, 0xce, 0x2e, 0x01, 0x00, 0x00,
}
