...
```sh
merlins tx tokenfactory create-denom ufoo --keyring-backend=test --from mylocalwallet
```
...
```sh
merlins tx tokenfactory mint 100000000000factory/fury1c584m4lq25h83yp6ag8hh4htjr92d954vklzja/ufoo --keyring-backend=test --from mylocalwallet
```
...
```sh
merlins query bank denom-metadata --denom factory/fury1c584m4lq25h83yp6ag8hh4htjr92d954vklzja/ufoo
```
...
```sh
merlins query tokenfactory denoms-from-creator fury1c584m4lq25h83yp6ag8hh4htjr92d954vklzja
```
