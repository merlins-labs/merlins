...
func (s *IntegrationTestSuite) TestGetCmdQueryParams() {
	...
	testCases := []struct {
	...
	}{
		{
			...
			`{"mint_denom":"stake","genesis_epoch_provisions":"4038461.53846154","epoch_identifier":"week","reduction_period_in_epochs":"156","reduction_factor":"0.500000000000000000","distribution_proportions":{"staking":"0.400000000000000000","pool_incentives":"0.020000000000000000","developer_rewards":"0.100000000000000000","community_pool":"0.280000000000000000"},"weighted_developer_rewards_receivers":[],"minting_rewards_distribution_start_epoch":"0"}`,
		},
		{
			"text output",
			[]string{fmt.Sprintf("--%s=1", flags.FlagHeight), fmt.Sprintf("--%s=text", tmcli.OutputFlag)},
			`distribution_proportions:
  community_pool: "0.280000000000000000"
  developer_rewards: "0.100000000000000000"
  pool_incentives: "0.020000000000000000"
