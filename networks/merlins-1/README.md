...
|----------|--------------|------------------------------------------------------------------------------------------------------------|
| darwin   | amd64        | [Download](https://merlins.fra1.digitaloceanspaces.com/binaries/cosmovisor/cosmovisor-v1.2.0-darwin-amd64) |
| darwin   | arm64        | [Download](https://merlins.fra1.digitaloceanspaces.com/binaries/cosmovisor/cosmovisor-v1.2.0-darwin-arm64) |
| linux    | amd64        | [Download](https://merlins.fra1.digitaloceanspaces.com/binaries/cosmovisor/cosmovisor-v1.2.0-linux-amd64)  |
| linux    | arm64        | [Download](https://merlins.fra1.digitaloceanspaces.com/binaries/cosmovisor/cosmovisor-v1.2.0-linux-arm64)  |
...
echo "📁 Creating the cosmovisor directory: ${merlins_home}/cosmovisor"
mkdir -p "${merlins_home}/cosmovisor"

# Create the genesis directory and download v3 binary to /cosmovisor/genesis/bin
echo "📁 Creating the genesis directory: ${merlins_home}/cosmovisor/genesis/bin"
mkdir -p "${merlins_home}/cosmovisor/genesis/bin"

echo "⬇️ Downloading v3 binary to: ${merlins_home}/cosmovisor/genesis/bin/merlins"
wget -q -O "${merlins_home}/cosmovisor/genesis/bin/merlins" "$(echo ${versions_info[0]} | cut -d: -f2)"
...
for version_info in "${versions_info[@]:1}"; do
    ...
    echo
    echo "📁 Creating ${version} directory: ${merlins_home}/cosmovisor/upgrades/${version}/bin"
    mkdir -p "${merlins_home}/cosmovisor/upgrades/${version}/bin"
    echo "⬇️  Downloading ${version} binary to: ${merlins_home}/cosmovisor/upgrades/${version}/bin/merlins"
    wget -q -O "${merlins_home}/cosmovisor/upgrades/${version}/bin/merlins" "$binary_url"
done
```
