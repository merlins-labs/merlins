...
Copy the current v14 merlins binary into the
...
cp $GOPATH/bin/merlins ~/.merlins/cosmovisor/upgrades/v14/bin
```
...
make build
cp build/merlins ~/.merlins/cosmovisor/upgrades/v15/bin
```
