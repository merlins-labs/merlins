# Setting Up a Genesis Merlins Validator
...
Finally, you should move the merlins binary into the cosmovisor/genesis
folder.

    mv $GOPATH/bin/merlins ~/.merlins/cosmovisor/genesis/bin
...
This work, ["Merlins Genesis Validators
