...
func TestCreateDenomMsg(t *testing.T) {
	...
	reflect := instantiateReflectContract(t, ctx, merlins, lucky)
	require.NotEmpty(t, reflect)

	msg := bindings.MerlinsMsg{CreateDenom: &bindings.CreateDenom{
		Subdenom: "SUN",
	}}
	err := executeCustom(t, ctx, merlins, reflect, lucky, msg, sdk.Coin{})
...
func TestMintMsg(t *testing.T) {
	...
	require.True(t, ok)
	msg = bindings.MerlinsMsg{MintTokens: &bindings.MintTokens{
		Denom:         sunDenom,
		Amount:        amount,
...
func TestBurnMsg(t *testing.T) {
	...
	msg = bindings.MerlinsMsg{BurnTokens: &bindings.BurnTokens{
		Denom:           sunDenom,
		Amount:          amount,
	...
	luckyBalance := merlins.BankKeeper.GetAllBalances(ctx, lucky)
	err = merlins.BankKeeper.SendCoins(ctx, lucky, reflect, luckyBalance)
	require.NoError(t, err)
...
func executeCustom(t *testing.T, ctx sdk.Context, merlins *app.MerlinsApp, contract sdk.AccAddress, sender sdk.AccAddress, msg bindings.MerlinsMsg, funds sdk.Coin) error {
	t.Helper()
