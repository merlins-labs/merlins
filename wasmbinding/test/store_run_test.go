...
func storeCodeViaProposal(t *testing.T, ctx sdk.Context, merlins *app.MerlinsApp, addr sdk.AccAddress) {
	t.Helper()
...
func TestStoreCodeProposal(t *testing.T) {
	...
	storeCodeViaProposal(t, ctx, merlins, myActorAddress)
...
func TestInstantiateContract(t *testing.T) {
	...
	FundAccount(t, ctx, merlins, funder)

	storeCodeViaProposal(t, ctx, merlins, funder)
