...
pub const CONTRACT_CHAIN: &str = "merlins";
...
impl<'a> Registry<'a> {
    ...
    /// Example: get_contract("registries") -> "fury1..."
    ...
    /// Example: get_connected_chain("merlins", "channel-42") -> "juno"
    ...
    /// Example: get_channel("merlins", "juno") -> "channel-0"
    /// Example: get_channel("juno", "merlins") -> "channel-42"
    ...
    /// Example: encode_addr_for_chain("fury1...", "juno") -> "juno1..."
    ...
    /// Example: get_bech32_prefix("merlins") -> "fury"
    ...
    ///
    /// Example: get_chain_for_bech32_prefix("fury") -> "merlins"
    ...
    /// Example: unwrap_denom_path("ibc/0A...") -> [{"local_denom":"ibc/0A","on":"merlins","via":"channel-17"},{"local_denom":"ibc/1B","on":"middle_chain","via":"channel-75"},{"local_denom":"token0","on":"source_chain","via":null}
    ...
    fn test_derive_wasmhooks_sender() {
        let test_cases = vec![
            (
                ...
                "fury",
                "fury1sguz3gtyl2tjsdulwxmtprd68xtd43yyep6g5c554utz642sr8rqcgw0q6",
            ),
            (
                "channel-1",
                "cosmos1tfejvgp5yzd8ypvn9t0e2uv2kcjf2laa8upya8",
                "fury",
                "fury1svnare87kluww5hnltv24m4dg72hst0qqwm5xslsvnwd22gftcussaz5l7",
            ),
            (
                "channel-0",
                "fury12smx2wdlyttvyzvzg54y2vnqwq2qjateuf7thj",
                "fury",
                "fury1vz8evs4ek3vnz4f8wy86nw9ayzn67y28vtxzjgxv6achc4pa8gesqldfz0",
            ),
            (
                "channel-0",
                "fury12smx2wdlyttvyzvzg54y2vnqwq2qjateuf7thj",
