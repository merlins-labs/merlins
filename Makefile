...
docker-build-e2e-init-chain:
	@DOCKER_BUILDKIT=1 docker build -t furylabs/merlins-e2e-init-chain:debug --build-arg E2E_SCRIPT_NAME=chain --platform=linux/x86_64 -f tests/e2e/initialization/init.Dockerfile .
