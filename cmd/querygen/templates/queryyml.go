...
type QueryYml struct {
	...
	// Path to client folder e.g. "github.com/osmosis-labs/osmosis/v17/x/twap/client"
...
type Keeper struct {
	// e.g. github.com/osmosis-labs/osmosis/v17/x/twap
...
// input is of form github.com/merlins-labs/merlins/vXX/{PATH}
// returns PATH
