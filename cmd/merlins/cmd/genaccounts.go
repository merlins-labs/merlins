...
// Example:
// 	merlins import-genesis-accounts-from-snapshot networks/cosmoshub-3/snapshot.json networks/merlins-1/ions.json output_address.json
// `,
...
// 					furyAddr, err := CosmosToOsmoAddress(acc.AtomAddress)
// 					if err != nil {
// 						return err
// 					}
...
// Example:
// 	merlins import-genesis-accounts-from-snapshot ../snapshot.json ../ions.json
// 	- Check input genesis:
