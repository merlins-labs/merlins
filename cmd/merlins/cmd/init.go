	...
	cmd := &cobra.Command{
		...
		RunE: func(cmd *cobra.Command, args []string) error {
			...
			seeds := []string{
				...
				"f515a8599b40f0e84dfad935ba414674ab11a668@merlins.blockpane.com:26656",                     // [ block pane ]
				"6bcdbcfd5d2c6ba58460f10dbcfde58278212833@merlins.artifact-staking.io:26656",               // Artifact Staking
				"24841abfc8fbd401d8c86747eec375649a2e8a7e@merlins.pbcups.org:26656",                        // Pbcups
				"77bb5fb9b6964d6e861e91c1d55cf82b67d838b5@bd-merlins-seed-mainnet-us-01.bdnodes.net:26656", // Blockdaemon US
				"3243426ab56b67f794fa60a79cc7f11bc7aa752d@bd-merlins-seed-mainnet-eu-02.bdnodes.net:26656", // Blockdaemon EU
				"ebc272824924ea1a27ea3183dd0b9ba713494f83@merlins-mainnet-seed.autostake.com:26716",        // AutoStake.com
				"7c66126b64cd66bafd9ccfc721f068df451d31a3@merlins-seed.sunshinevalidation.io:9393",         // Sunshine Validation
			}
...
func CreateEnvFile(cmd *cobra.Command) error {
	...
	if _, err := os.Stat(envPath); err != nil {
		...
		if os.IsNotExist(err) {
			...
			_, err = envFile.WriteString(fmt.Sprintf("MERLINS_ENVIRONMENT=%s", nodeHome))
			if err != nil {
				return err
			}
		}
